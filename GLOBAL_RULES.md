...
14. REGLA DE LEVANTAMIENTO AUTÓNOMO DE SERVICIOS WEB Y XAMPP: Prohibido dar excusas o pedir pasos manuales al usuario al solicitar subir un servidor o probar una web. Para proyectos PHP en `C:\xampp\php\www\[Proyecto]`, lanzar autónomamente el servidor PHP en puerto 8080 (`php -S 127.0.0.1:8080 -t "C:\xampp\php\www\[Proyecto]"`), validar la respuesta HTTP con `Invoke-WebRequest` y entregar la URL `http://127.0.0.1:8080` de inmediato.
