...
13. REGLA DE USO AUTÓNOMO Y ONBOARDING DE GRAPHIFY: Al solicitar el grafo de una app: (1) Si la app está indexada, levantar los servidores (http://127.0.0.1:4310) y mostrar el grafo directamente; (2) Si la app NO está en el catálogo, responder de forma concisa: "La aplicación [Nombre] aún no está incluida en el catálogo local de Graphify. ¿Deseas que la incluya e indexe ahora mismo?" sin preguntas teóricas.
