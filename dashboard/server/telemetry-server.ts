...
function buildBrainWorkflow(
  ...
  const nodes: WorkflowNode[] = [
    ...
    {
      id: "user",
      label: "Usuario & Telegram Gateway",
      role: "Canal de Ingress",
      detail: "Recepción de mensajes, comandos y archivos",
      purpose: "Recibe la solicitud original, asigna identificadores únicos (request_id) y valida el canal.",
      state: "healthy",
      kind: "user",
      stageId: "input",
      stageNumber: 1,
    ...
    },
    {
      ...
      role: "Canal de Chat",
      detail: "Gateway oficial de Hermes · Ingress autenticado",
      purpose: "Canaliza mensajes saneados de usuarios autorizados sin capacidad de mutación directa.",
      state: telegramState,
      kind: "interface",
      stageId: "input",
      stageNumber: 1,
    ...
    {
      id: "auth",
      label: "Autenticación & Idempotencia",
      role: "Filtro de duplicidad y permisos",
      detail: "Request UUID · Idempotency Key · Control de acceso",
      purpose: "Verifica la identidad del emisor, valida la clave de idempotencia e impide ejecuciones duplicadas.",
      state: "healthy",
      kind: "policy",
      stageId: "auth",
      stageNumber: 2,
    ...
    {
      id: "normalize",
      label: "Normalizador & Contrato",
      role: "Especificación de tarea",
      detail: "Objetivo, alcance, restricciones y criterios verificables",
      purpose: "Convierte la solicitud en una especificación técnica formal con criterios de aceptación probables.",
      state: "healthy",
      kind: "policy",
      stageId: "normalize",
      stageNumber: 3,
    ...
    {
      id: "preclassify",
      label: "Clasificador Preliminar L0-L4",
      role: "Evaluación inicial de riesgo 6D",
      detail: "Score 0-24 pts · Elevación automática L4 para seguridad/datos",
      purpose: "Calcula la complejidad estimada antes de consumir VRAM y asigna nivel de atención de L0 a L4.",
      state: "healthy",
      kind: "router",
      stageId: "preclassify",
      stageNumber: 4,
    ...
    // FASE B — CONTEXTO Y ENRUTAMIENTO
    {
      id: "brain",
      label: "HERMES BRAIN & Graphify",
      role: "Plano de control persistente",
      detail: `${brain.memory.graphNodes.toLocaleString("es-DO")} nodos AST · ${brain.memory.graphEdges.toLocaleString("es-DO")} relaciones`,
      purpose: "Recupera contexto estructural y gobierna las políticas inmutables de ejecución local.",
      state: status,
      kind: "control",
      stageId: "brain",
      stageNumber: 5,
    ...
    },
    {
      id: "trama",
      label: "TRAMA",
      role: "Observador lateral solo lectura",
      detail: "SSE read-only · Telemetría en vivo sin control mutante",
      purpose: "Supervisa telemetría, eventos y métricas de VRAM en vivo sin modificar código ni autorizar merges.",
      state: "healthy",
      kind: "observer",
      stageId: "brain",
    ...
    {
      id: "memory",
      label: "Memoria y Graphify",
      role: "Recuperación de código",
      detail: `${brain.memory.graphNodes.toLocaleString("es-DO")} nodos AST acotados`,
      purpose: "Identifica dependencias, firmas de métodos e impacta módulos específicos mediante el grafo.",
      state: brain.memory.state,
      kind: "memory",
      stageId: "routing",
      stageNumber: 6,
      phase: "context",
    ...
    {
      id: "router",
      label: "Model Router & VRAM",
      role: "Selección por capacidad",
      detail: `${brain.router.routes.length} rutas · Gemma / Agents-A1 / Qwen`,
      purpose: "Gestión de presupuesto de VRAM en LM Studio y conmutación entre Gemma 4, Agents-A1 y Qwen 35B.",
      state: brain.router.state,
      kind: "router",
      stageId: "routing",
      stageNumber: 6,
      phase: "context",
    ...
    },
    {
      id: "agents",
      label: "Agent Factory",
      role: "Asignación de perfiles",
      detail: `${brain.agents.operatorCount} operador · ${brain.agents.advisoryCount} asesores`,
      purpose: "Asigna los perfiles de agentes requeridos (Laravel, Android, Web, MCP) para la ejecución.",
      state: brain.agents.state,
      kind: "factory",
      stageId: "routing",
      stageNumber: 6,
      phase: "context",
    ...
    // FASE C — PLANIFICACIÓN Y EJECUCIÓN
    {
      id: "atomic-plan",
      label: "Atomic Planner & Grafo DAG",
      role: "Descomposición Atómica",
      detail: "Grafo DAG de tareas atómicas T-001..T-025 · Target del Repair Loop",
      purpose: "Descompone el objetivo en unidades de una sola acción verificable con dependencias explícitas.",
      state: status,
      kind: "policy",
      stageId: "atomic-plan",
      stageNumber: 7,
    ...
    },
    {
      ...
      role: "Control de ejecución aislada",
      detail: "Allowlist de rutas · Permisos acotados · Scope de trabajo",
      purpose: "Autoriza secuencialmente las tareas del DAG garantizando aislamiento en Worktree Git.",
      state: brain.sandbox.state,
      kind: "gateway",
      stageId: "plan",
      stageNumber: 8,
      phase: "execution",
    ...
    {
      id: "code-sandbox",
      label: "Sandbox de código",
      role: "Worktree Git aislado",
      detail: `${brain.sandbox.active.length} tareas activas en desarrollo`,
      purpose: "Ejecuta los cambios en archivos dentro del espacio de trabajo temporal sin alterar main.",
      state: brain.sandbox.state,
      kind: "executor",
      stageId: "sandbox",
      stageNumber: 9,
    ...
    },
    {
      ...
      role: "Validación en navegador",
      detail: "Acción de navegador real bajo alcance MCP",
      purpose: "Navega, interactúa, llena formularios y toma capturas visuales en navegadores Chromium/Chrome.",
      state: brain.sandbox.state,
      kind: "executor",
      stageId: "sandbox",
      stageNumber: 9,
    ...
    },
    {
      ...
      role: "Comandos controlados",
      detail: "Acciones de build, linters y scripts",
      purpose: "Ejecuta comandos CLI, compilaciones Gradle/Composer y scripts auxiliares bajo supervisión.",
      state: brain.sandbox.state,
      kind: "executor",
      stageId: "sandbox",
      stageNumber: 9,
    ...
    {
      id: "evidence",
      label: "Patch Gate & Evidencia",
      role: "Inspección de parches",
      detail: "Diff SHA-256 · Límites de líneas · Evidencia registrada",
      purpose: "Verifica que los parches no sobrepasen los presupuestos permitidos y sella la evidencia del cambio.",
    ...
    // FASE D — INTEGRACIÓN, CALIDAD Y REPARACIÓN
    {
      id: "integration",
      label: "Integración & Ensamblaje",
      role: "Ensamblaje del resultado",
      detail: "Contratos de API · Esquemas · Compatibilidad",
      purpose: "Combina el conjunto de parches de la tarea y verifica la coherencia funcional previa a las pruebas.",
      state: executionState,
      kind: "result",
      stageId: "integration",
      stageNumber: 11,
    ...
    {
      id: "validated",
      label: "Quality Gates Determinísticos",
      role: "Pruebas objetivas 100%",
      detail: "PHPUnit · ESLint · ktlint · detekt · Playwright tests",
      purpose: "Ejecuta la batería de pruebas automatizadas sin permitir saltos o bypasses manuales.",
      state: "healthy",
      kind: "result",
      stageId: "validated",
      stageNumber: 12,
    ...
    {
      id: "audit",
      label: "Auditoría Post-Ejecución",
      role: "Detección activa de errores",
      detail: "Requisitos · Seguridad · Datos · Regresión",
      purpose: "Inspecciona el resultado en busca de fallos no detectados por las pruebas normales.",
      state: "healthy",
      kind: "validation",
      stageId: "audit",
      stageNumber: 13,
    ...
    {
      id: "repair",
      label: "Repair Loop & Regresión",
      role: "Autocorrección de causas raíz",
      detail: "Fix Tasks T-Tasks · Max 5 estrategias · Retorno a Atomic Planner",
      purpose: "Transforma hallazgos críticos en tareas de corrección y retorna al Atomic Planner vía corredor lateral.",
      state: "healthy",
      kind: "validation",
      stageId: "repair",
      stageNumber: 14,
    ...
    // FASE E — APRENDIZAJE Y ENTREGA
    {
      id: "learning",
      label: "Learning Engine Saneado",
      role: "Aprendizaje seguro sin secretos",
      detail: `${brain.learning.counts.candidate ?? 0} candidatas de aprendizaje saneadas`,
      purpose: "Extrae patrones de solución verificados eliminando credenciales, secretos e hipótesis no probadas.",
      state: brain.learning.state,
      kind: "learning",
      stageId: "learning",
      stageNumber: 15,
      phase: "delivery",
    ...
    {
      id: "promotion",
      label: "Promoción, Memoria & Entrega",
      role: "Entrega verificada al usuario",
      detail: "COMPLETED_AND_VERIFIED · Actualización de memoria autorizada",
      purpose: "Promueve parches estables a la rama principal e informa el estado final real de la tarea.",
      state: brain.learning.promotionState,
      kind: "learning",
      stageId: "promotion",
      stageNumber: 16,
      phase: "delivery",
  ...
  return {
    nodes,
    edges: [
      link("user", "telegram", "01. Solicita", "input", "healthy", "observed", "forward", "bottom", "top"),
      link("telegram", "auth", "02. Ingress autenticado", "auth", telegramState, "observed", "forward", "bottom", "top"),
      link("auth", "normalize", "03. Idempotente", "normalize", "healthy", "observed", "forward", "bottom", "top"),
      link("normalize", "preclassify", "04. Contrato operativo", "preclassify", "healthy", "observed", "forward", "bottom", "top"),
      link("preclassify", "brain", "05. Complejidad L0-L4", "brain", "healthy", "observed", "forward", "bottom", "top"),
      link("brain", "trama", "Telemetría SSE (solo lectura)", "brain", "healthy", "observed", "observer", "left", "right"),
      link("brain", "memory", "Contexto AST", "routing", brain.memory.state, "observed", "branch", "bottom", "top"),
      link("brain", "router", "Capacidad VRAM", "routing", brain.router.state, "observed", "branch", "bottom", "top"),
      link("brain", "agents", "Especialistas", "routing", brain.agents.state, "observed", "branch", "bottom", "top"),
      link("memory", "atomic-plan", "AST Nodos & Grafos", "atomic-plan", brain.memory.state, "observed", "merge", "bottom", "top"),
      link("router", "atomic-plan", "Gemma / Agents-A1 / Qwen", "atomic-plan", brain.router.state, "observed", "merge", "bottom", "top"),
      link("agents", "atomic-plan", "Operadores asignados", "atomic-plan", brain.agents.state, "observed", "merge", "bottom", "top"),
      link("atomic-plan", "execution-gateway", "07. Tareas atómicas T-001", "plan", status, "observed", "forward", "bottom", "top"),
      link("execution-gateway", "code-sandbox", "Rama Código", "sandbox", brain.sandbox.state),
      ...
      link("code-sandbox", "evidence", "Diff & SHA-256", "evidence", executionState, "configured", "merge", "bottom", "top"),
      link("playwright", "evidence", "Capturas & Traces", "evidence", executionState, "configured", "merge", "bottom", "top"),
      link("automations", "evidence", "Logs & Salidas", "evidence", executionState, "configured", "merge", "bottom", "top"),
      link("evidence", "integration", "10. Parche verificado", "integration", executionState, "configured", "forward", "bottom", "top"),
      link("integration", "validated", "11. Ensamblaje coherente", "validated", executionState, "configured", "forward", "bottom", "top"),
      link("validated", "audit", "12. Quality Gates 100%", "audit", executionState, "configured", "forward", "bottom", "top"),
      link("audit", "repair", "Hallazgos / Errores", "repair", executionState, "configured", "branch", "right", "left"),
      link("repair", "atomic-plan", "Replanificación Repair Loop", "atomic-plan", executionState, "configured", "loop", "right", "right", 1460),
      link("audit", "learning", "13. Sin errores críticos", "learning", brain.learning.state, "configured", "forward", "bottom", "top"),
      link("learning", "promotion", "15. Aprendizaje saneado", "promotion", brain.learning.promotionState, "configured", "forward", "bottom", "top"),
    ],
  };
}
